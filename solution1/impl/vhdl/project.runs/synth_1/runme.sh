...
HD_PWD='/home/brett/workspace/Vivado_WS/pie_hls/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frameSIPO.vds -m64 -mode batch -messageDb vivado.pb -notrace -source frameSIPO.tcl
