...
HD_PWD='/home/brett/workspace/Vivado_WS/pie_hls/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log frameSIPO.vdi -applog -m64 -messageDb vivado.pb -mode batch -source frameSIPO.tcl -notrace
