...
set Library     "hls"
set IPName      "frameSIPO"
set Version     "1.0"
set DisplayName "Framesipo"
set Revision    "1609021156"
...
set Interfaces {
    ap_clk {
        ...
        buses "inData headerData_V_src_MAC_V headerData_V_dest_MAC_V headerData_V_ethertype_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    headerData_V_src_MAC_V {
        type "axi4stream"
        mode "master"
        port_prefix "headerData_V_src_MAC_V"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    headerData_V_dest_MAC_V {
        type "axi4stream"
        mode "master"
        port_prefix "headerData_V_dest_MAC_V"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    headerData_V_ethertype_V {
        type "axi4stream"
        mode "master"
        port_prefix "headerData_V_ethertype_V"
        has_tready "1"
        ports {
            TDATA 16
        }
...
## System Info
set user_parameters_list {clk_period 8.000000 machine 64 combinational 0 latency 1 II 1}
...
set enable_xo_gen 0
set kernel_files {/home/brett/workspace/Vivado_WS/pie_hls/solution1/frameSIPO.cpp}
if {$enable_xo_gen} {
