...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "frameSIPO.autotvin.dat"
	set constFileTvOut       "frameSIPO.autotvout.dat"
	set constFileHdlTvIn     "frameSIPO.autohdltvin.dat"
	set constFileHdlTvOut    "frameSIPO.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
