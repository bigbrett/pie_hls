...
$(ObjDir)/pie_tb.cpp_pre.cpp.tb.o : pie_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling pie_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/frameSIPO.cpp_pre.cpp.tb.o : frameSIPO.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling frameSIPO.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
