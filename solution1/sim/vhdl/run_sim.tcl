...
if {[file isfile frameSIPO.autotvin.dat]} {
	file delete -force frameSIPO.autotvin.dat
}

if {[file isfile frameSIPO.autotvout.dat]} {
	file delete -force frameSIPO.autotvout.dat
}
